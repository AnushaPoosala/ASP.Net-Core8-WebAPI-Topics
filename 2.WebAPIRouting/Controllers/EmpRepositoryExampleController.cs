...
namespace WebAPISampleProjectUsingVS2022.Controllers
{
    ...
    public class EmpRepositoryExampleController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetAllEmp")]
        //[Route("[action]")]--->the one between []s is called token, the one between () is called Route template
        ...
        //Delete emp
        [HttpDelete]
        [Route("~DeleteEmp/{EmpNo}")]   //placing ~ tild symbol will remove any Prefix before DEleteEmp
        ...
        [HttpGet("GetEmpByIdOrName/EmpId/{empId:int:range(100,1000)}/Name/{name:alpha}")]
