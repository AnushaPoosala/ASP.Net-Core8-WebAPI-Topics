...
namespace AutoMapperUsageInWebAPI.Migrations.EComDB
{
    ...
    [Migration("20250325194134_InitialCreate_EComDBContext")]
            ...
            modelBuilder.Entity("AutoMapperUsageInWebAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 10m,
                            CustomerId = 1,
                            OrderDate = new DateTime(2025, 3, 17, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            OrderId = 2,
            ...
            modelBuilder.Entity("AutoMapperUsageInWebAPI.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Brand = "Dell",
                            CategoryId = 0,
                            CreatedDateTime = new DateTime(2025, 3, 17, 0, 0, 0, 0, DateTimeKind.Utc),
